...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app_lab', '0002_remove_articleimage_article_delete_article_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='app_lab.article', verbose_name='Стаття')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='news', to='app_lab.category', verbose_name='Категорія'),
        ),
    ]
